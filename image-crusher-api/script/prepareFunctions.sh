...
echo "exports.run = require('./util/functionWrapper').wrap(require('./get'))" >> dist/get/index.js
...
echo "exports.run = require('./util/functionWrapper').wrap(require('./publishToStorage'))" >> dist/publishToStorage/index.js
...
echo "exports.run = require('./util/functionWrapper').wrap(require('./create'))" >> dist/create/index.js